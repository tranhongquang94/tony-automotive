...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Tony's Automotive</title>
      <meta name="keywords" content="Tony automotive">
      <meta name="description" content="You can browse and choose various cars from here.">
      ...
      <div class="header_section haeder_main">
         <div class="container-fluid">
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <!-- Logo -->
               <a class="navbar-brand" href="CarsListServlet"><img src="images/logo.png"></a></a>
               <form class="form-inline ">
                  <div class="login_text">
                     <ul>
                     	<c:if test="${sessionScope.email == null}">
                     		<li><a href="LoginServlet?action=login"><img src="images/user-icon.png"></a></li>
                     	</c:if>
      
                        <c:if test="${sessionScope.email != null}">
                        	<li><a href="CartServlet?action=view"><img src="images/trolly-icon.png">${sessionScope.cart.cars.size()}</a></li>
                        </c:if>
